...
// прод-БД (см. CONSTITUTION §1, и комментарий в CLAUDE.md про standalone Turso).
// Часть таблиц появится позже вместе с AI-чатом и портфельными модулями —
// отсутствующие пропускаем без ошибки.
